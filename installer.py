...
jdkBinary=["/zulu22.30.13-ca-jdk22.0.1-win_x64/bin/javaw.exe","/zulu22.30.13-ca-jdk22.0.1-macosx_x64/zulu-22.jdk/Contents/Home/bin/java","zulu22.30.13-ca-jdk22.0.1-linux_x64/bin/java"]
# 0 - ZGC
# 1 - ParNewGC
